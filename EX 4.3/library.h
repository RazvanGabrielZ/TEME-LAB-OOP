...
private:
    string content;
    Client* client;  // Pointer to the client who wrote the review
...
// Library Class - Manages the collection of books and search functionality
class Library {
private:
    vector<Book> books;
...
public:
    ...
    // Function to search for text in reviews or client names
